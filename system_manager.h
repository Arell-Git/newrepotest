...
/*!
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* @brief Print message to debug serial
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* @param[input]      format - message format
* @param[input]      ... - variadic parameters for message formatting
*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
*/
#define debug_msg(format, ...) fprintf(DEBUG_COMM, "DEBUG %s:%d: " format "\n", __FILE__, __LINE__, __VA_ARGS__)

/* Assert macro.
For debug use. */
#define assert(expr) if (!(expr)) panic("%s", "assertion failed")

/* Helper macros for debug message printing */
#ifdef DEBUG_L1
#define debug_L1(format, ...) fprintf(DEBUG_COMM, "DEBUG L1 %s:%d: " format "\n", __FILE__, __LINE__, __VA_ARGS__)
#else 
#define debug_L1(format, ...) ((void)0U)
#endif
#ifdef DEBUG_L2
#define debug_L2(format, ...) fprintf(DEBUG_COMM, "DEBUG L2 %s:%d: " format "\n", __FILE__, __LINE__, __VA_ARGS__)
#else 
#define debug_L2(format, ...) ((void)0U)
#endif
#ifdef DEBUG_L3
#define debug_L3(format, ...) fprintf(DEBUG_COMM, "DEBUG L3 %s:%d: " format "\n", __FILE__, __LINE__, __VA_ARGS__)
#else 
#define debug_L3(format, ...) ((void)0U)
#endif

#else
#define debug_msg(format, ...) ((void)0U)
